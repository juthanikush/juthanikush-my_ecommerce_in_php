                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form id="login-form" method="post">
                                                            ...
                                                            <span class="filed_error" id="login_email_error"></span>
                                                            <div class="single-input">
                                                                <input type="password" name="login_password" id="login_password" placeholder="Your Password*" style="width:100%">
                                                            </div>
                                                            <span class="filed_error" id="login_password_error"></span>
                                    ...
                                    <div class="accordion__body">
                                        <div class="paymentinfo">
                                            <div class="single-method">
                                               COD<input type="radio" name="payment_type" value="cod" required>  PayU<input type="radio" name="payment_type" value="patu" required>
                                            </div>
                                            <div class="single-method">
                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            ...
                            <div class="order-details__item">
                                ...
                                <div class="single-item">
                                    <div class="single-item__thumb">
                                        <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$image?>" alt="full-image">
                                    </div>
                            ...
                            <div class="ordre-details__total bilinfo">
                               <input type="text" name="coupen_code" id="coupon_str" style="height: 50px;margin-right: 10px;"><br><input type="button" name="submit" class="fv-btn" value="Apply Coupon" onclick="set_coupon()" />
                            </div>
                            <div id="coupon_result" style="padding: 33px;padding-top:0px;font-size:20px;font-weight:bold;">
