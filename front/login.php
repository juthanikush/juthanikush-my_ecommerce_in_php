...
<script type="text/javascript">
			...
			jQuery.ajax({
				...
				success:function(result){
					if(result=='done'){
						...
						//Query('.email_sent_otp').html('Sent OTP');
						...
						jQuery('.email_sent_otp').attr('disabled',false);
						jQuery('#email_error').html('Place Try After Some Time');
					}
				}
			});
	...
	function email_verify_otp(){
		...
		if(email_otp==''){
			jQuery('#email_error').html('Place Enter the OTP')
		}else{
			...
			jQuery.ajax({
				...
				success:function(result){
					if(result=='done'){
						...
						jQuery('#email_otp_result').html('Email id Verifed');
						jQuery('#is_email_verified').val('1');
						jQuery('#btn_registed').attr('disabled',false);
					
					}else{
						jQuery('#email_error').html('Place Enter Valide OTP');
					}
				}
			});
		}
