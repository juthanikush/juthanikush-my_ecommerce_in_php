...
if(isset($_POST['submit'])){
   $categories=get_safe_value($con,$_POST['catagories']);
                        ...
                        <form method="post">
                              <div class="card-body card-block">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="catagories" placeholder="Enter Catagories name" class="form-control" required value="<?php echo $categories; ?>">
                                 </div>
