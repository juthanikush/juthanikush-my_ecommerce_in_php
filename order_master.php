            ...
            <div class="orders">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="box-title">Order Master Detali</h4>
                        </div>
                        <div class="card-body--">
                              ...
                              <table class="table">
                                    <thead>
                                          <tr>
                                             ...
                                             <th class="product-add-to-cart"><span class="nobr">ship order id</span></th>
                                          </tr>
                                    </thead>
                                    <tbody>
                                          <?php
                                          ...
                                          ?>
                                            <tr>
                                               <td class="product-add-to-cart">
                                                   ...
                                                   <a href="front/order_pdf.php?id=<?php echo $row['id']?>">PDF</a></td>
