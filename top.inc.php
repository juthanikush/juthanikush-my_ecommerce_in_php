               ...
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                      <?php if($_SESSION['ADMIN_ROLE']==1){ 
                        echo '<a href="order_master_vender.php" >Order Master</a>';}
                        else{
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="catagories.php" > categories Master</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="sub_catagories.php" > Sub categories Master</a>
                  </li>
                  ...
                  <li class="menu-item-has-children dropdown">
                   ...
                   <li class="menu-item-has-children dropdown">
                     <a href="coupen_master.php" >Coupen Master</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="content_us.php" >Contact Us</a>
                  </li>
               <?php } ?>
               </ul>
            </div>
